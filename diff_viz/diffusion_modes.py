...
def plot_diffusion_modes_single_label(
    ecm,
    label_name,
    bar_width=0.01,
    figsize=(1, 4),
    color_constrained="#b7a57a",
    color_normal="#999999",
    color_directed="#4b2e83",
    ylim=(0, 1),
    ...
    brownian_percent = (
        ecm[(ecm["alpha"] <= 1.1) & (ecm["alpha"] >= 0.9)].shape[0] / ecm.shape[0]
    )
    ...
    plt.bar(
        label_name,
        superdiffusive_percent,
        bottom=subdiffusive_percent + brownian_percent,
    ...
    plt.title(
        f"Percentage of Diffusion Modes per {label_name}",
...
def plot_diffusion_modes(
    df,
    label_column,
    bar_width=0.5,
    figsize=(4, 8),
    color_subdiffusive="#b7a57a",
    color_brownian="#999999",
    color_superdiffusive="#4b2e83",
    ylim=(0, 1),
    legend_loc="lower right",
    legend_fontsize=14,
    title_fontsize=15,
    ...
    plt.bar(
        ...
        label="Subdiffusive",
        width=bar_width,
        color=color_subdiffusive,
    )
    plt.bar(
        labels,
        brownian_percent,
        bottom=subdiffusive_percent,
        color=color_brownian,
        label="Brownian",
        width=bar_width,
    )
    plt.bar(
    ...
    plt.legend(loc=legend_loc, fontsize=legend_fontsize)
    plt.title(
        f"Percentage of Diffusion Modes per {label_column}",
        fontsize=title_fontsize,
        fontname=title_font,
        fontweight="bold",
    )
